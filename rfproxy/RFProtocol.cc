...
static Vlog_module lg("RFProtocol");
}
...
PortRegister::PortRegister() {
    ...
    vigil::lg.dbg("In RFProtocol.cc, PortRegister, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
PortRegister::PortRegister(uint64_t vm_id, uint32_t vm_port, MACAddress hwaddress) {
    ...
    vigil::lg.dbg("In RFProtocol.cc, PortRegister, constructor with 3 parameters is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
PortConfig::PortConfig() {
    ...
    set_vm_port(0);
    set_operation_id(0);
    vigil::lg.dbg("In RFProtocol.cc, PortConfig, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
PortConfig::PortConfig(uint64_t vm_id, uint32_t vm_port, uint32_t operation_id) {
    ...
    vigil::lg.dbg("In RFProtocol.cc, PortConfig, constructor with 3 parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
DatapathPortRegister::DatapathPortRegister() {
    ...
    set_dp_id(0);
    set_dp_port(0);
    vigil::lg.dbg("In RFProtocol.cc, DatapathPortRegister, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
DatapathPortRegister::DatapathPortRegister(uint64_t ct_id, uint64_t dp_id, uint32_t dp_port) {
    ...
    set_dp_id(dp_id);
    set_dp_port(dp_port);
    vigil::lg.dbg("In RFProtocol.cc, DatapathPortRegister, constructor with 3 parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
DatapathDown::DatapathDown() {
    set_ct_id(0);
    set_dp_id(0);
    vigil::lg.dbg("In RFProtocol.cc, DatapathDown, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
DatapathDown::DatapathDown(uint64_t ct_id, uint64_t dp_id) {
    set_ct_id(ct_id);
    set_dp_id(dp_id);
    vigil::lg.dbg("In RFProtocol.cc, DatapathDown, constructor with 2 parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
VirtualPlaneMap::VirtualPlaneMap() {
    ...
    set_vs_id(0);
    set_vs_port(0);
    vigil::lg.dbg("In RFProtocol.cc, VirtualPlaneMap, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
VirtualPlaneMap::VirtualPlaneMap(uint64_t vm_id, uint32_t vm_port, uint64_t vs_id, uint32_t vs_port) {
    ...
    set_vs_id(vs_id);
    set_vs_port(vs_port);
    vigil::lg.dbg("In RFProtocol.cc, VirtualPlaneMap, constructor with 4 parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
DataPlaneMap::DataPlaneMap() {
    ...
    set_vs_id(0);
    set_vs_port(0);
    vigil::lg.dbg("In RFProtocol.cc, DataPlaneMap, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
DataPlaneMap::DataPlaneMap(uint64_t ct_id, uint64_t dp_id, uint32_t dp_port, uint64_t vs_id, uint32_t vs_port) {
    ...
    set_vs_id(vs_id);
    set_vs_port(vs_port);
    vigil::lg.dbg("In RFProtocol.cc, DataPlaneMap, constructor with 5 parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
RouteMod::RouteMod() {
    ...
    vigil::lg.dbg("In RFProtocol.cc, RouteMod, constructor with no parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
...
RouteMod::RouteMod(uint8_t mod, uint64_t id, std::vector<Match> matches, std::vector<Action> actions, std::vector<Option> options) {
    ...
    set_actions(actions);
    set_options(options);
    vigil::lg.dbg("In RFProtocol.cc, RouteMod, constructor with 5 parameter is called");
    vigil::lg.dbg("%s", this->str().c_str());
}
