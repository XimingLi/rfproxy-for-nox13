...
#define ETH_TOTAL_MAX_1 (ETH_HEADER_LEN + ETH_PAYLOAD_MAX + ETH_CRC_LEN)
#define RF_MAX_PACKET_SIZE (VLAN_HEADER_LEN + ETH_TOTAL_MAX_1)
...
typedef enum route_mod_type {
	RMT_ADD = 48,		/* Add flow to datapath */
	RMT_DELETE = 49		/* Remove flow from datapath */
