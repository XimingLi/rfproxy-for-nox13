 ...
 * }
 *
 * Where "value" is converted from "byte_order_use" to network byte-order.
 */
mongo::BSONObj TLV::TLV_to_BSON(const TLV* tlv, byte_order_use order) {
